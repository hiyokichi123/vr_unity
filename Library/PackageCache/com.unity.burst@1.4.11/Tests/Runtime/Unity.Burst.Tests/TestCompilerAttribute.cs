...
#pragma warning restore 0414
        ...
        protected virtual bool SupportException => false;
        ...
        internal abstract class TestCompilerCommandBase : TestCommand
        {
            ...
            protected virtual Type CreateNativeDelegateType(Type returnType, Type[] arguments, out bool isInRegistry,
                ...
                if (!RunningArmTestOnIntelCPU(methodInfo))
                {
                    ...
                    if (_expectCompilerException)
                    {
                        ...
                        var expectedExceptionResult = TryExpectedException(
                            context,
                            () => TransformArguments(_originalMethod.Method.MethodInfo, arguments, out _, out _, returnBox,
                                out _),
